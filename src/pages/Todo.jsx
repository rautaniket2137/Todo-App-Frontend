...
//     try {
//       const res = await getTodo(); // ✅ now res = array
...
//           _id: todo._id,
//           text: todo.text, // make sure backend sends text
...
//         text: newTask, // ✅ FIX (title भेजो backend को)
//         dueDate,
//       });
...
// if (!saved) {
//   console.log("❌ Invalid create response", res.data);
//   return;
// }
...
//       setTasks((prev) => ({
//         ...prev,
//         incomplete: [taskData, ...prev.incomplete],
//       }));
...
//     const updated = res.todo; // ✅ FIXED

//     const updatedTask = {
//       _id: updated._id,
//       text: updated.text, // ✅ FIXED
...
//   try {
//     const res = await updateTodo(taskId, {
//       text: newText, // ✅ send object
//     });

//     const updated = res.todo; // ✅ FIX

//     const updatedTask = {
//       _id: updated._id,
//       text: updated.text, // ✅ backend uses title
//       dueDate: updated.dueDate,
//       createdAt: updated.createdAt,
...
//                               task._id,
//                               status,
//                               status === "incomplete" ? "doing" : "completed"
//                             )
//                           }
...
//                       <button onClick={()=>updateTask(tasks)}
